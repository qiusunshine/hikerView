...
// ObjToIntMap is a copy cat of ObjToIntMap with API adjusted to object keys
    ...
    public static class Iterator {
        ...
        public void next() {
            if (remaining == -1) com.example.hikerview.ui.js.javascript.Kit.codeBug();
            if (remaining == 0) {
                remaining = -1;
                cursor = -1;
            }else {
    ...
    public ObjToIntMap(int keyCountHint) {
        if (keyCountHint < 0) com.example.hikerview.ui.js.javascript.Kit.codeBug();
        // Table grow when number of stored keys >= 3/4 of max capacity
        int minimalCapacity = keyCountHint * 4 / 3;
        int i;
        for (i = 2; (1 << i) < minimalCapacity; ++i) { }
        power = i;
        if (check && power < 2) com.example.hikerview.ui.js.javascript.Kit.codeBug();
    }
    ...
    private int findIndex(Object key) {
        if (keys != null) {
            ...
            if (test != null) {
                ...
                for (;;) {
                    if (check) {
                        if (n >= occupiedCount) com.example.hikerview.ui.js.javascript.Kit.codeBug();
                        ++n;
                    }
...
// and enough free space
    private int insertNewKey(Object key, int hash) {
        if (check && occupiedCount != keyCount) com.example.hikerview.ui.js.javascript.Kit.codeBug();
        if (check && keyCount == 1 << power) com.example.hikerview.ui.js.javascript.Kit.codeBug();
        int fraction = hash * A;
        int index = fraction >>> (32 - power);
        int N = 1 << power;
        if (keys[index] != null) {
            ...
            do {
                if (check && keys[index] == DELETED) com.example.hikerview.ui.js.javascript.Kit.codeBug();
                index = (index + step) & mask;
                if (check && firstIndex == index) com.example.hikerview.ui.js.javascript.Kit.codeBug();
    ...
    private void rehashTable() {
        if (keys == null) {
            if (check && keyCount != 0) com.example.hikerview.ui.js.javascript.Kit.codeBug();
            if (check && occupiedCount != 0) com.example.hikerview.ui.js.javascript.Kit.codeBug();
            int N = 1 << power;
            keys = new Object[N];
            values = new int[2 * N];
        }
