...
class AdUrlListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<AdBlockUrl> list;
    private OnItemClickListener onItemClickListener;

    AdUrlListAdapter(Context context, List<AdBlockUrl> list) {
        this.context = context;
        this.list = list;
    }

    interface OnItemClickListener {
        void onDelete(View view, int position, AdBlockUrl adBlockRule);
        void onLongClick(View view, int position, AdBlockUrl adBlockRule);
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, final int position) {
        if (viewHolder instanceof RuleHolder) {
            ...
            String title = list.get(position).getUrl();
