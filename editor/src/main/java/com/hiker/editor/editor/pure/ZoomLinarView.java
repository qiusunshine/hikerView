package com.hiker.editor.editor.pure;
 ...
 * 时间：At 23:33
 */
public class ZoomLinarView extends LinearLayout {
    ...
    public ZoomLinarView(Context context) {
        super(context);
    }

    public ZoomLinarView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public void init(EditText editText, float scaleGas) {
