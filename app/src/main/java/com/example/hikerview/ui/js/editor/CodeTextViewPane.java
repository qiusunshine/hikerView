...
public class CodeTextViewPane extends HVScrollView {
    CodeTextView mCodeText;
    int mCodeTextMinHeight;
    int mCodeTextMinWidth;

    public CodeTextViewPane(Context context) {
        super(context);
        init();

    }

    public CodeTextViewPane(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        mCodeText = new CodeTextView(getContext());
