 ...
 * Base64格式图片解析器
 */
public class Base64ImageLoader extends AbstractImageLoader<byte[]> implements Runnable {

    public Base64ImageLoader(ImageHolder holder, RichTextConfig config, TextView textView, DrawableWrapper drawableWrapper, ImageLoadNotify iln) {
