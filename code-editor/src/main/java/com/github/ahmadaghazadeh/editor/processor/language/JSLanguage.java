...
public class JSLanguage extends Language {
    ...
    private static final String[] JS_KEYWORDS = new String[]{
            "function", "var", "map", "let", "filter", "sort", "Map", "Set", "indexOf", "split", "replace", "join",
            "length", "unshift", "push", "parseInt", "test", "match", "Referer", "User-Agent", "return", "Cookie",
            "document", "window", "querySelector", "querySelectorAll", "throw", "Error", "try", "catch", "console", "decodeURI", "startsWith", "endsWith", "RegExp",
            "decodeURIComponent", "encodeURI", "encodeURIComponent", "escape", "innerHeight", "innerWidth",
            "location", "open", "outerHeight", "outerWidth", "parent", "parseInt", "setInterval", "setTimeout", "unescape", "break", "case", "Math",
            "Number", "Object", "undefined", "prototype", "eval", "Date", "Array", "getTime", "reload", "addEventListener", "write", "open",
            "alert", "confirm", "prompt", "replace", "lastIndexOf", "charAt", "slice", "trim", "forEach", "every", "some",
            "reduce", "pop", "shift", "reverse", "concat", "splice", "isArray", "keys", "includes", "find", "fill",
            "ceil", "cos", "exp", "floor", "log", "max", "min", "pow", "random", "round", "sin", "sqrt", "tan", "getDate", "getDay", "getFullYear", "getHours", "getMilliseconds",
            "getMinutes", "getMonth", "getSeconds", "constructor", "JSON", "parse", "stringify"
    };
