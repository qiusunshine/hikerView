...
public class DebugTextViewHelper extends Player.DefaultEventListener implements Runnable {
  ...
  public static String getDecoderCountersBufferCountString(DecoderCounters counters) {
    if (counters == null) {
      return "";
    }
  ...
  public static String getPixelAspectRatioString(float pixelAspectRatio) {
